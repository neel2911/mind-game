...
import type { TabsType } from "@/types/game";

const { play, rules, settings } = string.tabs;

export const GameTabs = () => {
  const { currentTab, handleUpdateTab } = useSettings();
  return (
    <Tabs
      className="w-full flex flex-col items-center"
      value={currentTab}
      onValueChange={(value) => handleUpdateTab(value as TabsType)}
    >
